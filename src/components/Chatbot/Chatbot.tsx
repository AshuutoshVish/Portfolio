...
export default function Chatbot() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      role: "assistant",
      content: "Hi! I'm AshBOT, here to answer questions about Ashutosh, his work, projects, and experience. What would you like to know?",
    },
  ]);
          ...
          >
            ...
            <div className="bg-gradient-to-r from-purple-600/20 to-blue-600/20 border-b border-white/10 p-4 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-white font-semibold text-sm">AshBOT</h3>
                  <p className="text-gray-400 text-xs">I can answer questions about Ashutosh's work</p>
                </div>
              </div>
              <button
                onClick={handleToggle}
                className="w-8 h-8 rounded-full bg-white/5 hover:bg-white/10 flex items-center justify-center text-gray-400 hover:text-white transition-colors"
                aria-label="Close AshBOT"
              >
                <X className="w-4 h-4" />
              </button>
            </div>
